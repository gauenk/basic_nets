...
from basic_net.modules.nls import NlsConv2d
...
def init_conv(cfg,name):
    if name == "deform":
        ...
        return NlsConv2d(32,32,name,cfg.k,cfg.ws,ps=cfg.ps,nheads=cfg.nheads,
...
class BasicNet(nn.Module):
    def __init__(self,cfg,method_name,ncls,in_chnls):
